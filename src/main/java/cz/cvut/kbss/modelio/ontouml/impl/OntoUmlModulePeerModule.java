 ...
 *
 */
public class OntoUmlModulePeerModule implements IPeerModule {
    private OntoUmlModule module;
	
    private IModuleAPIConfiguration peerConfiguration;
    
	OntoUmlModulePeerModule(OntoUmlModule statModuleModule, IModuleAPIConfiguration peerConfiguration) {
		super();
