 ...
 *
 */
public class ExportVocabularyToCompactOwlCommand extends AbstractExportVocabularyCommand {
    ...
    public void _actionPerformed(List<MObject> selectedElements, IModule module) {
        new VocabularyExporter( module).exportVocabulary((Package) selectedElements.iterator().next(), ExportType.COMPACT);
    }
}
