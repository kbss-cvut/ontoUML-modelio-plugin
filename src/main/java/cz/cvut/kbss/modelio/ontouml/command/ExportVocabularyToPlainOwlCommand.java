 ...
 *
 */
public class ExportVocabularyToPlainOwlCommand extends AbstractExportVocabularyCommand {
    ...
    public void _actionPerformed(List<MObject> selectedElements, IModule module) {
        new VocabularyExporter(module).exportVocabulary((Package) selectedElements.iterator().next(), ExportType.PLAIN);
    }
}
